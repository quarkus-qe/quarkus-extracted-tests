...
public final class MutinyGreeterGrpc implements io.quarkus.grpc.MutinyGrpc {
    ...
    public static class MutinyGreeterStub extends io.grpc.stub.AbstractStub<MutinyGreeterStub> implements io.quarkus.grpc.MutinyStub {
        ...
        public io.smallrye.mutiny.Uni<examples.GpReply> greet(examples.GpRequest request) {
            return io.quarkus.grpc.stubs.ClientCalls.oneToOne(request, delegateStub::greet);
        }
    }
    ...
    public static abstract class GreeterImplBase implements io.grpc.BindableService {
        ...
        public io.grpc.ServerServiceDefinition bindService() {
            return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor()).addMethod(examples.GreeterGrpc.getGreetMethod(), asyncUnaryCall(new MethodHandlers<examples.GpRequest, examples.GpReply>(this, METHODID_GREET, compression))).build();
        }
    }
    ...
    private static final class MethodHandlers<Req, Resp> implements io.grpc.stub.ServerCalls.UnaryMethod<Req, Resp>, io.grpc.stub.ServerCalls.ServerStreamingMethod<Req, Resp>, io.grpc.stub.ServerCalls.ClientStreamingMethod<Req, Resp>, io.grpc.stub.ServerCalls.BidiStreamingMethod<Req, Resp> {
        ...
        public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch(methodId) {
                case METHODID_GREET:
                    io.quarkus.grpc.stubs.ServerCalls.oneToOne((examples.GpRequest) request, (io.grpc.stub.StreamObserver<examples.GpReply>) responseObserver, compression, serviceImpl::greet);
                    break;
                default:
