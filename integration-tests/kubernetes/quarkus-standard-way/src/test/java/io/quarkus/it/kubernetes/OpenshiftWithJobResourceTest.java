...
public class OpenshiftWithJobResourceTest {

    static final String APP_NAME = "openshift-with-job-resource";
    ...
    static final QuarkusProdModeTest config = new QuarkusProdModeTest()
            ...
            .setForcedDependencies(List.of(Dependency.of("io.quarkus", "quarkus-openshift", System.getProperty("core.quarkus.version"))));
