...
public class KnativeWithHealthUsingManagementInterfaceTest {
    ...
    static final QuarkusProdModeTest config = new QuarkusProdModeTest()
            ...
            .withConfigurationResource("knative-with-health-and-management.properties")
            .setForcedDependencies(List.of(Dependency.of("io.quarkus", "quarkus-smallrye-health", System.getProperty("core.quarkus.version"))));
