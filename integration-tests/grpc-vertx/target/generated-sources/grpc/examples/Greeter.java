...
public interface Greeter extends MutinyService {
    ...
    io.smallrye.mutiny.Uni<examples.HelloReply> sayJo(com.google.protobuf.Empty request);

    io.smallrye.mutiny.Uni<examples.HelloReply> threadName(examples.HelloRequest request);
}
