...
import io.quarkus.it.data.hibernate.Book.Repository;
import io.quarkus.it.data.hibernate.Book_.Repository_;
...
/**
 * Static metamodel for {@link io.quarkus.it.data.hibernate.Book}
 **/
@StaticMetamodel(Book.class)
@Generated("org.hibernate.processor.HibernateProcessor")
public abstract class Book_ extends AutoLong_ {

	/**
	 * Implements repository {@link io.quarkus.it.data.hibernate.Book.Repository}
	 **/
	@Dependent
	@Generated("org.hibernate.processor.HibernateProcessor")
	public static class Repository_ implements Repository {
		 ...
		 *
		 * @see io.quarkus.it.data.hibernate.Book.Repository#findByAuthor(String)
		 **/
		@Override
		 ...
		 *
		 * @see io.quarkus.it.data.hibernate.Book.Repository#findByTitle(String)
		 **/
		@Override
	...
	/**
	 * Static metamodel type for {@link io.quarkus.it.data.hibernate.Book}
	 **/
	public static volatile EntityType<Book> class_;
	
	/**
	 * Static metamodel for attribute {@link io.quarkus.it.data.hibernate.Book#title}
	 **/
	public static volatile SingularAttribute<Book, String> title;
	
	/**
	 * Static metamodel for attribute {@link io.quarkus.it.data.hibernate.Book#author}
	 **/
	public static volatile SingularAttribute<Book, String> author;
	
	/**
	 * Static metamodel for attribute {@link io.quarkus.it.data.hibernate.Book#pages}
	 **/
	...
	@Dependent
	@Generated("org.hibernate.processor.HibernateProcessor")
	public static class PanacheStatelessBlockingRepository_ implements io.quarkus.data.hibernate.stateless.blocking.BlockingRecordRepositoryBase<Book, java.lang.Long> {
	}
