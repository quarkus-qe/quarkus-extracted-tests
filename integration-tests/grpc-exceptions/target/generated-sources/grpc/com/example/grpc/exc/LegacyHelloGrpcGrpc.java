...
public final class LegacyHelloGrpcGrpc {
     ...
     */
    public static LegacyHelloGrpcBlockingV2Stub newBlockingV2Stub(io.grpc.Channel channel) {
        io.grpc.stub.AbstractStub.StubFactory<LegacyHelloGrpcBlockingV2Stub> factory = new io.grpc.stub.AbstractStub.StubFactory<LegacyHelloGrpcBlockingV2Stub>() {

            @java.lang.Override
            public LegacyHelloGrpcBlockingV2Stub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
                return new LegacyHelloGrpcBlockingV2Stub(channel, callOptions);
            }
        };
        return LegacyHelloGrpcBlockingV2Stub.newStub(factory, channel);
    }
     ...
     */
    public static class LegacyHelloGrpcBlockingV2Stub extends io.grpc.stub.AbstractBlockingStub<LegacyHelloGrpcBlockingV2Stub> {

        private LegacyHelloGrpcBlockingV2Stub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            super(channel, callOptions);
        }

        @java.lang.Override
        protected LegacyHelloGrpcBlockingV2Stub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new LegacyHelloGrpcBlockingV2Stub(channel, callOptions);
        }

        /**
         */
        public com.example.grpc.exc.HelloReply legacySayHello(com.example.grpc.exc.HelloRequest request) throws io.grpc.StatusException {
            return io.grpc.stub.ClientCalls.blockingV2UnaryCall(getChannel(), getLegacySayHelloMethod(), getCallOptions(), request);
        }
    }

    /**
     * A stub to allow clients to do limited synchronous rpc calls to service LegacyHelloGrpc.
     */
