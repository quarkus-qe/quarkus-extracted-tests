...
public final class HelloGrpcGrpc {
    ...
    private static volatile io.grpc.MethodDescriptor<com.example.grpc.exc.HelloRequest, com.example.grpc.exc.HelloReply> getSayHelloMethod;

    @io.grpc.stub.annotations.RpcMethod(fullMethodName = SERVICE_NAME + '/' + "SayHello", requestType = com.example.grpc.exc.HelloRequest.class, responseType = com.example.grpc.exc.HelloReply.class, methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
    public static io.grpc.MethodDescriptor<com.example.grpc.exc.HelloRequest, com.example.grpc.exc.HelloReply> getSayHelloMethod() {
        io.grpc.MethodDescriptor<com.example.grpc.exc.HelloRequest, com.example.grpc.exc.HelloReply> getSayHelloMethod;
        if ((getSayHelloMethod = HelloGrpcGrpc.getSayHelloMethod) == null) {
            synchronized (HelloGrpcGrpc.class) {
                if ((getSayHelloMethod = HelloGrpcGrpc.getSayHelloMethod) == null) {
                    HelloGrpcGrpc.getSayHelloMethod = getSayHelloMethod = io.grpc.MethodDescriptor.<com.example.grpc.exc.HelloRequest, com.example.grpc.exc.HelloReply>newBuilder().setType(io.grpc.MethodDescriptor.MethodType.UNARY).setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello")).setSampledToLocalTracing(true).setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(com.example.grpc.exc.HelloRequest.getDefaultInstance())).setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(com.example.grpc.exc.HelloReply.getDefaultInstance())).setSchemaDescriptor(new HelloGrpcMethodDescriptorSupplier("SayHello")).build();
                }
            }
        }
     ...
     */
    public static HelloGrpcBlockingV2Stub newBlockingV2Stub(io.grpc.Channel channel) {
        io.grpc.stub.AbstractStub.StubFactory<HelloGrpcBlockingV2Stub> factory = new io.grpc.stub.AbstractStub.StubFactory<HelloGrpcBlockingV2Stub>() {

            @java.lang.Override
            public HelloGrpcBlockingV2Stub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
                return new HelloGrpcBlockingV2Stub(channel, callOptions);
            }
        };
        return HelloGrpcBlockingV2Stub.newStub(factory, channel);
    }
    ...
    public interface AsyncService {
        ...
        /**
         */
        default void sayHello(com.example.grpc.exc.HelloRequest request, io.grpc.stub.StreamObserver<com.example.grpc.exc.HelloReply> responseObserver) {
    ...
    public static class HelloGrpcStub extends io.grpc.stub.AbstractAsyncStub<HelloGrpcStub> {
        ...
        /**
         */
        public void sayHello(com.example.grpc.exc.HelloRequest request, io.grpc.stub.StreamObserver<com.example.grpc.exc.HelloReply> responseObserver) {
     ...
     */
    public static class HelloGrpcBlockingV2Stub extends io.grpc.stub.AbstractBlockingStub<HelloGrpcBlockingV2Stub> {

        private HelloGrpcBlockingV2Stub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            super(channel, callOptions);
        }

        @java.lang.Override
        protected HelloGrpcBlockingV2Stub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new HelloGrpcBlockingV2Stub(channel, callOptions);
        }

        /**
         */
        public com.example.grpc.exc.HelloReply sayHello(com.example.grpc.exc.HelloRequest request) throws io.grpc.StatusException {
            return io.grpc.stub.ClientCalls.blockingV2UnaryCall(getChannel(), getSayHelloMethod(), getCallOptions(), request);
        }
    }

    /**
     * A stub to allow clients to do limited synchronous rpc calls to service HelloGrpc.
     */
    public static class HelloGrpcBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloGrpcBlockingStub> {
        ...
        /**
         */
        public com.example.grpc.exc.HelloReply sayHello(com.example.grpc.exc.HelloRequest request) {
    ...
    public static class HelloGrpcFutureStub extends io.grpc.stub.AbstractFutureStub<HelloGrpcFutureStub> {
        ...
        /**
         */
        public com.google.common.util.concurrent.ListenableFuture<com.example.grpc.exc.HelloReply> sayHello(com.example.grpc.exc.HelloRequest request) {
        ...
        public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch(methodId) {
                case METHODID_SAY_HELLO:
                    serviceImpl.sayHello((com.example.grpc.exc.HelloRequest) request, (io.grpc.stub.StreamObserver<com.example.grpc.exc.HelloReply>) responseObserver);
                    break;
                default:
    ...
    public static io.grpc.ServerServiceDefinition bindService(AsyncService service) {
        return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor()).addMethod(getSayHelloMethod(), io.grpc.stub.ServerCalls.asyncUnaryCall(new MethodHandlers<com.example.grpc.exc.HelloRequest, com.example.grpc.exc.HelloReply>(service, METHODID_SAY_HELLO))).build();
    }
