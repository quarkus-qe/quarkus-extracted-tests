...
import static com.example.grpc.exc.HelloGrpcGrpc.getServiceDescriptor;
...
public final class MutinyHelloGrpcGrpc implements io.quarkus.grpc.MutinyGrpc {
    ...
    public static abstract class HelloGrpcImplBase implements io.grpc.BindableService {
        ...
        public io.grpc.ServerServiceDefinition bindService() {
            return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor()).addMethod(com.example.grpc.exc.HelloGrpcGrpc.getSayHelloMethod(), asyncUnaryCall(new MethodHandlers<com.example.grpc.exc.HelloRequest, com.example.grpc.exc.HelloReply>(this, METHODID_SAY_HELLO, compression))).build();
        }
    }
        ...
        public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch(methodId) {
                case METHODID_SAY_HELLO:
                    io.quarkus.grpc.stubs.ServerCalls.oneToOne((com.example.grpc.exc.HelloRequest) request, (io.grpc.stub.StreamObserver<com.example.grpc.exc.HelloReply>) responseObserver, compression, serviceImpl::sayHello);
                    break;
                default:
