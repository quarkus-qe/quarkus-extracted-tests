...
public final class ReactiveTestGrpc {
     ...
     */
    public static ReactiveTestBlockingV2Stub newBlockingV2Stub(io.grpc.Channel channel) {
        io.grpc.stub.AbstractStub.StubFactory<ReactiveTestBlockingV2Stub> factory = new io.grpc.stub.AbstractStub.StubFactory<ReactiveTestBlockingV2Stub>() {

            @java.lang.Override
            public ReactiveTestBlockingV2Stub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
                return new ReactiveTestBlockingV2Stub(channel, callOptions);
            }
        };
        return ReactiveTestBlockingV2Stub.newStub(factory, channel);
    }
     ...
     */
    public static class ReactiveTestBlockingV2Stub extends io.grpc.stub.AbstractBlockingStub<ReactiveTestBlockingV2Stub> {

        private ReactiveTestBlockingV2Stub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            super(channel, callOptions);
        }

        @java.lang.Override
        protected ReactiveTestBlockingV2Stub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new ReactiveTestBlockingV2Stub(channel, callOptions);
        }
        ...
        public io.grpc.stub.BlockingClientCall<?, com.example.reactive.Test.Item> watch(com.example.reactive.Test.Empty request) {
            return io.grpc.stub.ClientCalls.blockingV2ServerStreamingCall(getChannel(), getWatchMethod(), getCallOptions(), request);
        }

        /**
         */
        public com.example.reactive.Test.Empty add(com.example.reactive.Test.Item request) throws io.grpc.StatusException {
            return io.grpc.stub.ClientCalls.blockingV2UnaryCall(getChannel(), getAddMethod(), getCallOptions(), request);
        }
    }

    /**
     * A stub to allow clients to do limited synchronous rpc calls to service ReactiveTest.
     */
