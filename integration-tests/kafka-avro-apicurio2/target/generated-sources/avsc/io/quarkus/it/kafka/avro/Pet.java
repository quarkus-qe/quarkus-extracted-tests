...
public class Pet extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6044672364171070409L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Pet\",\"namespace\":\"io.quarkus.it.kafka.avro\",\"fields\":[{\"name\":\"name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"color\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public Pet(java.lang.String name, java.lang.String color) {
    this.name = name;
    this.color = color;
  }
   ...
   */
  public static io.quarkus.it.kafka.avro.Pet.Builder newBuilder() {
    return new io.quarkus.it.kafka.avro.Pet.Builder();
  }
   ...
   * @return A new Pet RecordBuilder
   */
  public static io.quarkus.it.kafka.avro.Pet.Builder newBuilder(io.quarkus.it.kafka.avro.Pet.Builder other) {
    if (other == null) {
      return new io.quarkus.it.kafka.avro.Pet.Builder();
    } else {
      return new io.quarkus.it.kafka.avro.Pet.Builder(other);
    }
  }
   ...
   * @return A new Pet RecordBuilder
   */
  public static io.quarkus.it.kafka.avro.Pet.Builder newBuilder(io.quarkus.it.kafka.avro.Pet other) {
    if (other == null) {
      return new io.quarkus.it.kafka.avro.Pet.Builder();
    } else {
      return new io.quarkus.it.kafka.avro.Pet.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Pet>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.quarkus.it.kafka.avro.Pet.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.quarkus.it.kafka.avro.Pet other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.quarkus.it.kafka.avro.Pet.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.quarkus.it.kafka.avro.Pet.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.quarkus.it.kafka.avro.Pet.Builder setColor(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.quarkus.it.kafka.avro.Pet.Builder clearColor() {
      color = null;
  ...
  public boolean equals(Object o) {
    ...
    if (!java.util.Objects.equals(this.color, other.color)) {
      return false;
    }
    return true;
  }
