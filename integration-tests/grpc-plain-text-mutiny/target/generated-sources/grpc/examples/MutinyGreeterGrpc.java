...
public final class MutinyGreeterGrpc implements io.quarkus.grpc.MutinyGrpc {
    ...
    public static class MutinyGreeterStub extends io.grpc.stub.AbstractStub<MutinyGreeterStub> implements io.quarkus.grpc.MutinyStub {
        ...
        public io.smallrye.mutiny.Uni<examples.HelloReply> greeting(examples.LanguageSpec request) {
            return io.quarkus.grpc.stubs.ClientCalls.oneToOne(request, delegateStub::greeting);
        }
    }
    ...
    public static abstract class GreeterImplBase implements io.grpc.BindableService {
        ...
        public io.grpc.ServerServiceDefinition bindService() {
            return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor()).addMethod(examples.GreeterGrpc.getSayHelloMethod(), asyncUnaryCall(new MethodHandlers<examples.HelloRequest, examples.HelloReply>(this, METHODID_SAY_HELLO, compression))).addMethod(examples.GreeterGrpc.getGreetingMethod(), asyncUnaryCall(new MethodHandlers<examples.LanguageSpec, examples.HelloReply>(this, METHODID_GREETING, compression))).build();
        }
    }
        ...
        public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch(methodId) {
                ...
                case METHODID_GREETING:
                    io.quarkus.grpc.stubs.ServerCalls.oneToOne((examples.LanguageSpec) request, (io.grpc.stub.StreamObserver<examples.HelloReply>) responseObserver, compression, serviceImpl::greeting);
                    break;
                default:
