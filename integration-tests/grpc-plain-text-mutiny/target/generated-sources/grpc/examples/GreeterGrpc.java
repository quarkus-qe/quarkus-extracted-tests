...
public final class GreeterGrpc {
    ...
    private static volatile io.grpc.MethodDescriptor<examples.LanguageSpec, examples.HelloReply> getGreetingMethod;

    @io.grpc.stub.annotations.RpcMethod(fullMethodName = SERVICE_NAME + '/' + "Greeting", requestType = examples.LanguageSpec.class, responseType = examples.HelloReply.class, methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
    public static io.grpc.MethodDescriptor<examples.LanguageSpec, examples.HelloReply> getGreetingMethod() {
        io.grpc.MethodDescriptor<examples.LanguageSpec, examples.HelloReply> getGreetingMethod;
        if ((getGreetingMethod = GreeterGrpc.getGreetingMethod) == null) {
            synchronized (GreeterGrpc.class) {
                if ((getGreetingMethod = GreeterGrpc.getGreetingMethod) == null) {
                    GreeterGrpc.getGreetingMethod = getGreetingMethod = io.grpc.MethodDescriptor.<examples.LanguageSpec, examples.HelloReply>newBuilder().setType(io.grpc.MethodDescriptor.MethodType.UNARY).setFullMethodName(generateFullMethodName(SERVICE_NAME, "Greeting")).setSampledToLocalTracing(true).setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(examples.LanguageSpec.getDefaultInstance())).setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(examples.HelloReply.getDefaultInstance())).setSchemaDescriptor(new GreeterMethodDescriptorSupplier("Greeting")).build();
                }
            }
        }
    ...
    public interface AsyncService {
        ...
        /**
         */
        default void greeting(examples.LanguageSpec request, io.grpc.stub.StreamObserver<examples.HelloReply> responseObserver) {
    ...
    public static class GreeterStub extends io.grpc.stub.AbstractAsyncStub<GreeterStub> {
        ...
        /**
         */
        public void greeting(examples.LanguageSpec request, io.grpc.stub.StreamObserver<examples.HelloReply> responseObserver) {
            io.grpc.stub.ClientCalls.asyncUnaryCall(getChannel().newCall(getGreetingMethod(), getCallOptions()), request, responseObserver);
        }
    }
    ...
    public static class GreeterBlockingV2Stub extends io.grpc.stub.AbstractBlockingStub<GreeterBlockingV2Stub> {
        ...
        /**
         */
        public examples.HelloReply greeting(examples.LanguageSpec request) throws io.grpc.StatusException {
            return io.grpc.stub.ClientCalls.blockingV2UnaryCall(getChannel(), getGreetingMethod(), getCallOptions(), request);
        }
    }
    ...
    public static class GreeterBlockingStub extends io.grpc.stub.AbstractBlockingStub<GreeterBlockingStub> {
        ...
        /**
         */
        public examples.HelloReply greeting(examples.LanguageSpec request) {
            return io.grpc.stub.ClientCalls.blockingUnaryCall(getChannel(), getGreetingMethod(), getCallOptions(), request);
        }
    }
    ...
    public static class GreeterFutureStub extends io.grpc.stub.AbstractFutureStub<GreeterFutureStub> {
        ...
        /**
         */
        public com.google.common.util.concurrent.ListenableFuture<examples.HelloReply> greeting(examples.LanguageSpec request) {
            return io.grpc.stub.ClientCalls.futureUnaryCall(getChannel().newCall(getGreetingMethod(), getCallOptions()), request);
        }
    }
        ...
        public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch(methodId) {
                ...
                case METHODID_GREETING:
                    serviceImpl.greeting((examples.LanguageSpec) request, (io.grpc.stub.StreamObserver<examples.HelloReply>) responseObserver);
                    break;
                default:
    ...
    public static io.grpc.ServerServiceDefinition bindService(AsyncService service) {
        return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor()).addMethod(getSayHelloMethod(), io.grpc.stub.ServerCalls.asyncUnaryCall(new MethodHandlers<examples.HelloRequest, examples.HelloReply>(service, METHODID_SAY_HELLO))).addMethod(getGreetingMethod(), io.grpc.stub.ServerCalls.asyncUnaryCall(new MethodHandlers<examples.LanguageSpec, examples.HelloReply>(service, METHODID_GREETING))).build();
    }
    ...
    public static io.grpc.ServiceDescriptor getServiceDescriptor() {
        ...
        if (result == null) {
            synchronized (GreeterGrpc.class) {
                ...
                if (result == null) {
                    serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME).setSchemaDescriptor(new GreeterFileDescriptorSupplier()).addMethod(getSayHelloMethod()).addMethod(getGreetingMethod()).build();
                }
            }
        }
        return result;
