...
import static org.acme.HelloGrpcGrpc.getServiceDescriptor;
...
public final class MutinyHelloGrpcGrpc implements io.quarkus.grpc.MutinyGrpc {
    ...
    public static class MutinyHelloGrpcStub extends io.grpc.stub.AbstractStub<MutinyHelloGrpcStub> implements io.quarkus.grpc.MutinyStub {
        ...
        public io.smallrye.mutiny.Uni<org.acme.HelloReply> sayHello(org.acme.HelloRequest request) {
    ...
    public static abstract class HelloGrpcImplBase implements io.grpc.BindableService {
        ...
        public io.grpc.ServerServiceDefinition bindService() {
            return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor()).addMethod(org.acme.HelloGrpcGrpc.getSayHelloMethod(), asyncUnaryCall(new MethodHandlers<org.acme.HelloRequest, org.acme.HelloReply>(this, METHODID_SAY_HELLO, compression))).build();
        }
    }
        ...
        public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch(methodId) {
                case METHODID_SAY_HELLO:
                    io.quarkus.grpc.stubs.ServerCalls.oneToOne((org.acme.HelloRequest) request, (io.grpc.stub.StreamObserver<org.acme.HelloReply>) responseObserver, compression, serviceImpl::sayHello);
                    break;
                default:
