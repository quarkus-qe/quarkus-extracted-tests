...
public final class HelloGrpcGrpc {
    ...
    private static volatile io.grpc.MethodDescriptor<org.acme.HelloRequest, org.acme.HelloReply> getSayHelloMethod;

    @io.grpc.stub.annotations.RpcMethod(fullMethodName = SERVICE_NAME + '/' + "SayHello", requestType = org.acme.HelloRequest.class, responseType = org.acme.HelloReply.class, methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
    public static io.grpc.MethodDescriptor<org.acme.HelloRequest, org.acme.HelloReply> getSayHelloMethod() {
        io.grpc.MethodDescriptor<org.acme.HelloRequest, org.acme.HelloReply> getSayHelloMethod;
        if ((getSayHelloMethod = HelloGrpcGrpc.getSayHelloMethod) == null) {
            synchronized (HelloGrpcGrpc.class) {
                if ((getSayHelloMethod = HelloGrpcGrpc.getSayHelloMethod) == null) {
                    HelloGrpcGrpc.getSayHelloMethod = getSayHelloMethod = io.grpc.MethodDescriptor.<org.acme.HelloRequest, org.acme.HelloReply>newBuilder().setType(io.grpc.MethodDescriptor.MethodType.UNARY).setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello")).setSampledToLocalTracing(true).setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(org.acme.HelloRequest.getDefaultInstance())).setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(org.acme.HelloReply.getDefaultInstance())).setSchemaDescriptor(new HelloGrpcMethodDescriptorSupplier("SayHello")).build();
                }
            }
        }
    ...
    public interface AsyncService {
        ...
        /**
         */
        default void sayHello(org.acme.HelloRequest request, io.grpc.stub.StreamObserver<org.acme.HelloReply> responseObserver) {
    ...
    public static class HelloGrpcStub extends io.grpc.stub.AbstractAsyncStub<HelloGrpcStub> {
        ...
        /**
         */
        public void sayHello(org.acme.HelloRequest request, io.grpc.stub.StreamObserver<org.acme.HelloReply> responseObserver) {
    ...
    public static class HelloGrpcBlockingV2Stub extends io.grpc.stub.AbstractBlockingStub<HelloGrpcBlockingV2Stub> {
        ...
        /**
         */
        public org.acme.HelloReply sayHello(org.acme.HelloRequest request) throws io.grpc.StatusException {
    ...
    public static class HelloGrpcBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloGrpcBlockingStub> {
        ...
        /**
         */
        public org.acme.HelloReply sayHello(org.acme.HelloRequest request) {
    ...
    public static class HelloGrpcFutureStub extends io.grpc.stub.AbstractFutureStub<HelloGrpcFutureStub> {
        ...
        /**
         */
        public com.google.common.util.concurrent.ListenableFuture<org.acme.HelloReply> sayHello(org.acme.HelloRequest request) {
        ...
        public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch(methodId) {
                case METHODID_SAY_HELLO:
                    serviceImpl.sayHello((org.acme.HelloRequest) request, (io.grpc.stub.StreamObserver<org.acme.HelloReply>) responseObserver);
                    break;
                default:
    ...
    public static io.grpc.ServerServiceDefinition bindService(AsyncService service) {
        return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor()).addMethod(getSayHelloMethod(), io.grpc.stub.ServerCalls.asyncUnaryCall(new MethodHandlers<org.acme.HelloRequest, org.acme.HelloReply>(service, METHODID_SAY_HELLO))).build();
    }
    ...
    private static abstract class HelloGrpcBaseDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier, io.grpc.protobuf.ProtoServiceDescriptorSupplier {
        ...
        public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
            return org.acme.HelloGrpcProto.getDescriptor();
        }
