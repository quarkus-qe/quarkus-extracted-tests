...
public final class StreamingGrpc {
    ...
    public static io.grpc.ServerServiceDefinition bindService(AsyncService service) {
        return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor()).addMethod(getSourceMethod(), io.grpc.stub.ServerCalls.asyncServerStreamingCall(new MethodHandlers<io.grpc.examples.streaming.Empty, io.grpc.examples.streaming.Item>(service, METHODID_SOURCE))).addMethod(getSinkMethod(), io.grpc.stub.ServerCalls.asyncClientStreamingCall(new MethodHandlers<io.grpc.examples.streaming.Item, io.grpc.examples.streaming.Empty>(service, METHODID_SINK))).addMethod(getPipeMethod(), io.grpc.stub.ServerCalls.asyncBidiStreamingCall(new MethodHandlers<io.grpc.examples.streaming.Item, io.grpc.examples.streaming.Item>(service, METHODID_PIPE))).build();
    }
    ...
    public static io.grpc.ServiceDescriptor getServiceDescriptor() {
        ...
        if (result == null) {
            synchronized (StreamingGrpc.class) {
                ...
                if (result == null) {
                    serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME).setSchemaDescriptor(new StreamingFileDescriptorSupplier()).addMethod(getSourceMethod()).addMethod(getSinkMethod()).addMethod(getPipeMethod()).build();
                }
            }
        }
        return result;
