...
public interface Greeter extends MutinyService {
    ...
    io.smallrye.mutiny.Uni<examples.HelloReply> sayHelloRoleAdmin(examples.HelloRequest request);

    io.smallrye.mutiny.Uni<examples.HelloReply> sayHelloRoleUser(examples.HelloRequest request);
}
