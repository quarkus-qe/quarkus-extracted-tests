...
public final class GreeterGrpc {
    ...
    public static class GreeterBlockingV2Stub extends io.grpc.stub.AbstractBlockingStub<GreeterBlockingV2Stub> {
        ...
        /**
         */
        public examples.HelloReply sayHelloRoleAdmin(examples.HelloRequest request) throws io.grpc.StatusException {
            return io.grpc.stub.ClientCalls.blockingV2UnaryCall(getChannel(), getSayHelloRoleAdminMethod(), getCallOptions(), request);
        }

        /**
         */
        public examples.HelloReply sayHelloRoleUser(examples.HelloRequest request) throws io.grpc.StatusException {
            return io.grpc.stub.ClientCalls.blockingV2UnaryCall(getChannel(), getSayHelloRoleUserMethod(), getCallOptions(), request);
        }
    }
