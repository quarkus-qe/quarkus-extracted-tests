...
public class SchemaUser extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public int hashCode() {
    ...
    result = 31 * result + (privacyImported == null ? 0 : ((java.lang.Enum) privacyImported).ordinal());
    result = 31 * result + (privacyDirectImport == null ? 0 : ((java.lang.Enum) privacyDirectImport).ordinal());
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SchemaUser)) {
      return false;
    }
    SchemaUser other = (SchemaUser) o;
    ...
    if (!java.util.Objects.equals(this.privacyImported, other.privacyImported)) {
      return false;
    }
    if (!java.util.Objects.equals(this.privacyDirectImport, other.privacyDirectImport)) {
      return false;
    }
    if (!java.util.Objects.equals(this.time, other.time)) {
      return false;
    }
    return true;
  }
