...
public final class CopycatGrpc {
     ...
     */
    public static CopycatBlockingV2Stub newBlockingV2Stub(io.grpc.Channel channel) {
        io.grpc.stub.AbstractStub.StubFactory<CopycatBlockingV2Stub> factory = new io.grpc.stub.AbstractStub.StubFactory<CopycatBlockingV2Stub>() {

            @java.lang.Override
            public CopycatBlockingV2Stub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
                return new CopycatBlockingV2Stub(channel, callOptions);
            }
        };
        return CopycatBlockingV2Stub.newStub(factory, channel);
    }
     ...
     */
    public static class CopycatBlockingV2Stub extends io.grpc.stub.AbstractBlockingStub<CopycatBlockingV2Stub> {

        private CopycatBlockingV2Stub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            super(channel, callOptions);
        }

        @java.lang.Override
        protected CopycatBlockingV2Stub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new CopycatBlockingV2Stub(channel, callOptions);
        }
         ...
         * </pre>
         */
        public examples.HelloReply sayCat(examples.HelloRequest request) throws io.grpc.StatusException {
            return io.grpc.stub.ClientCalls.blockingV2UnaryCall(getChannel(), getSayCatMethod(), getCallOptions(), request);
        }

        /**
         */
        @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/10918")
        public io.grpc.stub.BlockingClientCall<examples.HelloRequest, examples.HelloReply> multiCat() {
            return io.grpc.stub.ClientCalls.blockingBidiStreamingCall(getChannel(), getMultiCatMethod(), getCallOptions());
        }
    }

    /**
     * A stub to allow clients to do limited synchronous rpc calls to service Copycat.
     */
