...
public final class GreeterGrpc {
    ...
    private static volatile io.grpc.MethodDescriptor<examples.HelloRequest, examples.HelloReply> getMultiHelloMethod;

    @io.grpc.stub.annotations.RpcMethod(fullMethodName = SERVICE_NAME + '/' + "MultiHello", requestType = examples.HelloRequest.class, responseType = examples.HelloReply.class, methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
    public static io.grpc.MethodDescriptor<examples.HelloRequest, examples.HelloReply> getMultiHelloMethod() {
        io.grpc.MethodDescriptor<examples.HelloRequest, examples.HelloReply> getMultiHelloMethod;
        if ((getMultiHelloMethod = GreeterGrpc.getMultiHelloMethod) == null) {
            synchronized (GreeterGrpc.class) {
                if ((getMultiHelloMethod = GreeterGrpc.getMultiHelloMethod) == null) {
                    GreeterGrpc.getMultiHelloMethod = getMultiHelloMethod = io.grpc.MethodDescriptor.<examples.HelloRequest, examples.HelloReply>newBuilder().setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING).setFullMethodName(generateFullMethodName(SERVICE_NAME, "MultiHello")).setSampledToLocalTracing(true).setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(examples.HelloRequest.getDefaultInstance())).setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(examples.HelloReply.getDefaultInstance())).setSchemaDescriptor(new GreeterMethodDescriptorSupplier("MultiHello")).build();
                }
            }
        }
    ...
    public interface AsyncService {
        ...
        /**
         */
        default io.grpc.stub.StreamObserver<examples.HelloRequest> multiHello(io.grpc.stub.StreamObserver<examples.HelloReply> responseObserver) {
    ...
    public static class GreeterStub extends io.grpc.stub.AbstractAsyncStub<GreeterStub> {
        ...
        /**
         */
        public io.grpc.stub.StreamObserver<examples.HelloRequest> multiHello(io.grpc.stub.StreamObserver<examples.HelloReply> responseObserver) {
            return io.grpc.stub.ClientCalls.asyncBidiStreamingCall(getChannel().newCall(getMultiHelloMethod(), getCallOptions()), responseObserver);
        }
    }
    ...
    public static class GreeterBlockingV2Stub extends io.grpc.stub.AbstractBlockingStub<GreeterBlockingV2Stub> {
        ...
        public io.grpc.stub.BlockingClientCall<examples.HelloRequest, examples.HelloReply> multiHello() {
            return io.grpc.stub.ClientCalls.blockingBidiStreamingCall(getChannel(), getMultiHelloMethod(), getCallOptions());
        }
    }
    ...
    private static final int METHODID_MULTI_HELLO = 1;
        ...
        public io.grpc.stub.StreamObserver<Req> invoke(io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch(methodId) {
                case METHODID_MULTI_HELLO:
                    return (io.grpc.stub.StreamObserver<Req>) serviceImpl.multiHello((io.grpc.stub.StreamObserver<examples.HelloReply>) responseObserver);
                default:
                    throw new AssertionError();
            }
        }
    ...
    public static io.grpc.ServerServiceDefinition bindService(AsyncService service) {
        return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor()).addMethod(getSayHelloMethod(), io.grpc.stub.ServerCalls.asyncUnaryCall(new MethodHandlers<examples.HelloRequest, examples.HelloReply>(service, METHODID_SAY_HELLO))).addMethod(getMultiHelloMethod(), io.grpc.stub.ServerCalls.asyncBidiStreamingCall(new MethodHandlers<examples.HelloRequest, examples.HelloReply>(service, METHODID_MULTI_HELLO))).build();
    }
    ...
    public static io.grpc.ServiceDescriptor getServiceDescriptor() {
        ...
        if (result == null) {
            synchronized (GreeterGrpc.class) {
                ...
                if (result == null) {
                    serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME).setSchemaDescriptor(new GreeterFileDescriptorSupplier()).addMethod(getSayHelloMethod()).addMethod(getMultiHelloMethod()).build();
                }
            }
        }
        return result;
