...
public class MyRepository_ implements MyRepository {
	 ...
	 *
	 * @see io.quarkus.it.hibernate.processor.data.pudefault.MyRepository#findById(Long)
	 **/
	@Override
	public Optional<MyEntity> findById(@Nonnull Long id) {
	 ...
	 *
	 * @see io.quarkus.it.hibernate.processor.data.pudefault.MyRepository#deleteById(Long)
	 **/
	@Override
