...
public final class MutinyGreeterGrpc implements io.quarkus.grpc.MutinyGrpc {
    ...
    public static class MutinyGreeterStub extends io.grpc.stub.AbstractStub<MutinyGreeterStub> implements io.quarkus.grpc.MutinyStub {
         ...
         * </pre>
         */
        public io.smallrye.mutiny.Uni<examples.HelloReply> sayHelloReader(examples.HelloRequest request) {
            return io.quarkus.grpc.stubs.ClientCalls.oneToOne(request, delegateStub::sayHelloReader);
        }

        public io.smallrye.mutiny.Uni<examples.HelloReply> sayHelloWriter(examples.HelloRequest request) {
            return io.quarkus.grpc.stubs.ClientCalls.oneToOne(request, delegateStub::sayHelloWriter);
        }
    }
    ...
    public static abstract class GreeterImplBase implements io.grpc.BindableService {
        ...
        public io.grpc.ServerServiceDefinition bindService() {
            return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor()).addMethod(examples.GreeterGrpc.getSayHelloReaderMethod(), asyncUnaryCall(new MethodHandlers<examples.HelloRequest, examples.HelloReply>(this, METHODID_SAY_HELLO_READER, compression))).addMethod(examples.GreeterGrpc.getSayHelloWriterMethod(), asyncUnaryCall(new MethodHandlers<examples.HelloRequest, examples.HelloReply>(this, METHODID_SAY_HELLO_WRITER, compression))).build();
        }
    }
        ...
        public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch(methodId) {
                case METHODID_SAY_HELLO_READER:
                    io.quarkus.grpc.stubs.ServerCalls.oneToOne((examples.HelloRequest) request, (io.grpc.stub.StreamObserver<examples.HelloReply>) responseObserver, compression, serviceImpl::sayHelloReader);
                    break;
                case METHODID_SAY_HELLO_WRITER:
                    io.quarkus.grpc.stubs.ServerCalls.oneToOne((examples.HelloRequest) request, (io.grpc.stub.StreamObserver<examples.HelloReply>) responseObserver, compression, serviceImpl::sayHelloWriter);
                    break;
                default:
