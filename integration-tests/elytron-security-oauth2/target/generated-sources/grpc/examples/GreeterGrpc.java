...
public final class GreeterGrpc {
    ...
    public static class GreeterBlockingV2Stub extends io.grpc.stub.AbstractBlockingStub<GreeterBlockingV2Stub> {
         ...
         * </pre>
         */
        public examples.HelloReply sayHelloReader(examples.HelloRequest request) throws io.grpc.StatusException {
            return io.grpc.stub.ClientCalls.blockingV2UnaryCall(getChannel(), getSayHelloReaderMethod(), getCallOptions(), request);
        }

        /**
         */
        public examples.HelloReply sayHelloWriter(examples.HelloRequest request) throws io.grpc.StatusException {
            return io.grpc.stub.ClientCalls.blockingV2UnaryCall(getChannel(), getSayHelloWriterMethod(), getCallOptions(), request);
        }
    }
