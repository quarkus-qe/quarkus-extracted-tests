...
public final class GreeterGrpc {
    ...
    private static volatile io.grpc.MethodDescriptor<io.quarkus.it.opentelemetry.grpc.HelloRequest, io.quarkus.it.opentelemetry.grpc.HelloReply> getSayHelloMethod;

    @io.grpc.stub.annotations.RpcMethod(fullMethodName = SERVICE_NAME + '/' + "SayHello", requestType = io.quarkus.it.opentelemetry.grpc.HelloRequest.class, responseType = io.quarkus.it.opentelemetry.grpc.HelloReply.class, methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
    public static io.grpc.MethodDescriptor<io.quarkus.it.opentelemetry.grpc.HelloRequest, io.quarkus.it.opentelemetry.grpc.HelloReply> getSayHelloMethod() {
        io.grpc.MethodDescriptor<io.quarkus.it.opentelemetry.grpc.HelloRequest, io.quarkus.it.opentelemetry.grpc.HelloReply> getSayHelloMethod;
        if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
            synchronized (GreeterGrpc.class) {
                if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
                    GreeterGrpc.getSayHelloMethod = getSayHelloMethod = io.grpc.MethodDescriptor.<io.quarkus.it.opentelemetry.grpc.HelloRequest, io.quarkus.it.opentelemetry.grpc.HelloReply>newBuilder().setType(io.grpc.MethodDescriptor.MethodType.UNARY).setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello")).setSampledToLocalTracing(true).setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(io.quarkus.it.opentelemetry.grpc.HelloRequest.getDefaultInstance())).setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(io.quarkus.it.opentelemetry.grpc.HelloReply.getDefaultInstance())).setSchemaDescriptor(new GreeterMethodDescriptorSupplier("SayHello")).build();
                }
            }
        }
    ...
    public interface AsyncService {
         ...
         * </pre>
         */
        default void sayHello(io.quarkus.it.opentelemetry.grpc.HelloRequest request, io.grpc.stub.StreamObserver<io.quarkus.it.opentelemetry.grpc.HelloReply> responseObserver) {
    ...
    public static class GreeterStub extends io.grpc.stub.AbstractAsyncStub<GreeterStub> {
         ...
         * </pre>
         */
        public void sayHello(io.quarkus.it.opentelemetry.grpc.HelloRequest request, io.grpc.stub.StreamObserver<io.quarkus.it.opentelemetry.grpc.HelloReply> responseObserver) {
    ...
    public static class GreeterBlockingV2Stub extends io.grpc.stub.AbstractBlockingStub<GreeterBlockingV2Stub> {
         ...
         * </pre>
         */
        public io.quarkus.it.opentelemetry.grpc.HelloReply sayHello(io.quarkus.it.opentelemetry.grpc.HelloRequest request) throws io.grpc.StatusException {
    ...
    public static class GreeterBlockingStub extends io.grpc.stub.AbstractBlockingStub<GreeterBlockingStub> {
         ...
         * </pre>
         */
        public io.quarkus.it.opentelemetry.grpc.HelloReply sayHello(io.quarkus.it.opentelemetry.grpc.HelloRequest request) {
    ...
    public static class GreeterFutureStub extends io.grpc.stub.AbstractFutureStub<GreeterFutureStub> {
         ...
         * </pre>
         */
        public com.google.common.util.concurrent.ListenableFuture<io.quarkus.it.opentelemetry.grpc.HelloReply> sayHello(io.quarkus.it.opentelemetry.grpc.HelloRequest request) {
        ...
        public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch(methodId) {
                case METHODID_SAY_HELLO:
                    serviceImpl.sayHello((io.quarkus.it.opentelemetry.grpc.HelloRequest) request, (io.grpc.stub.StreamObserver<io.quarkus.it.opentelemetry.grpc.HelloReply>) responseObserver);
                    break;
                default:
    ...
    public static io.grpc.ServerServiceDefinition bindService(AsyncService service) {
        return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor()).addMethod(getSayHelloMethod(), io.grpc.stub.ServerCalls.asyncUnaryCall(new MethodHandlers<io.quarkus.it.opentelemetry.grpc.HelloRequest, io.quarkus.it.opentelemetry.grpc.HelloReply>(service, METHODID_SAY_HELLO))).build();
    }
    ...
    private static abstract class GreeterBaseDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier, io.grpc.protobuf.ProtoServiceDescriptorSupplier {
        ...
        public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
            return io.quarkus.it.opentelemetry.grpc.HelloProto.getDescriptor();
        }
    ...
    public static io.grpc.ServiceDescriptor getServiceDescriptor() {
        ...
        if (result == null) {
            synchronized (GreeterGrpc.class) {
                ...
                if (result == null) {
                    serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME).setSchemaDescriptor(new GreeterFileDescriptorSupplier()).addMethod(getSayHelloMethod()).build();
                }
            }
        }
        return result;
