...
import static io.quarkus.it.opentelemetry.grpc.GreeterGrpc.getServiceDescriptor;
...
public final class MutinyGreeterGrpc implements io.quarkus.grpc.MutinyGrpc {
    ...
    public static abstract class GreeterImplBase implements io.grpc.BindableService {
        ...
        public io.grpc.ServerServiceDefinition bindService() {
            return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor()).addMethod(io.quarkus.it.opentelemetry.grpc.GreeterGrpc.getSayHelloMethod(), asyncUnaryCall(new MethodHandlers<io.quarkus.it.opentelemetry.grpc.HelloRequest, io.quarkus.it.opentelemetry.grpc.HelloReply>(this, METHODID_SAY_HELLO, compression))).build();
        }
    }
        ...
        public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch(methodId) {
                case METHODID_SAY_HELLO:
                    io.quarkus.grpc.stubs.ServerCalls.oneToOne((io.quarkus.it.opentelemetry.grpc.HelloRequest) request, (io.grpc.stub.StreamObserver<io.quarkus.it.opentelemetry.grpc.HelloReply>) responseObserver, compression, serviceImpl::sayHello);
                    break;
                default:
