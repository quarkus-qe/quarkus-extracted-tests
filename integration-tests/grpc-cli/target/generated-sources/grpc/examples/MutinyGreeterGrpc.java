...
public final class MutinyGreeterGrpc implements io.quarkus.grpc.MutinyGrpc {
    ...
    public static class MutinyGreeterStub extends io.grpc.stub.AbstractStub<MutinyGreeterStub> implements io.quarkus.grpc.MutinyStub {
        ...
        public io.smallrye.mutiny.Multi<examples.HelloReply> multiHello(io.smallrye.mutiny.Multi<examples.HelloRequest> request) {
            return io.quarkus.grpc.stubs.ClientCalls.manyToMany(request, delegateStub::multiHello);
        }
    }
    ...
    public static abstract class GreeterImplBase implements io.grpc.BindableService {
        ...
        public io.grpc.ServerServiceDefinition bindService() {
            return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor()).addMethod(examples.GreeterGrpc.getSayHelloMethod(), asyncUnaryCall(new MethodHandlers<examples.HelloRequest, examples.HelloReply>(this, METHODID_SAY_HELLO, compression))).addMethod(examples.GreeterGrpc.getMultiHelloMethod(), asyncBidiStreamingCall(new MethodHandlers<examples.HelloRequest, examples.HelloReply>(this, METHODID_MULTI_HELLO, compression))).build();
        }
    }
        ...
        public io.grpc.stub.StreamObserver<Req> invoke(io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch(methodId) {
                case METHODID_MULTI_HELLO:
                    return (io.grpc.stub.StreamObserver<Req>) io.quarkus.grpc.stubs.ServerCalls.manyToMany((io.grpc.stub.StreamObserver<examples.HelloReply>) responseObserver, serviceImpl::multiHello);
                default:
                    throw new java.lang.AssertionError();
            }
        }
