...
public final class GreeterGrpc {
    ...
    private static volatile io.grpc.MethodDescriptor<examples.HelloRequest, examples.HelloReply> getStreamHelloMethod;

    @io.grpc.stub.annotations.RpcMethod(fullMethodName = SERVICE_NAME + '/' + "StreamHello", requestType = examples.HelloRequest.class, responseType = examples.HelloReply.class, methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
    public static io.grpc.MethodDescriptor<examples.HelloRequest, examples.HelloReply> getStreamHelloMethod() {
        io.grpc.MethodDescriptor<examples.HelloRequest, examples.HelloReply> getStreamHelloMethod;
        if ((getStreamHelloMethod = GreeterGrpc.getStreamHelloMethod) == null) {
            synchronized (GreeterGrpc.class) {
                if ((getStreamHelloMethod = GreeterGrpc.getStreamHelloMethod) == null) {
                    GreeterGrpc.getStreamHelloMethod = getStreamHelloMethod = io.grpc.MethodDescriptor.<examples.HelloRequest, examples.HelloReply>newBuilder().setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING).setFullMethodName(generateFullMethodName(SERVICE_NAME, "StreamHello")).setSampledToLocalTracing(true).setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(examples.HelloRequest.getDefaultInstance())).setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(examples.HelloReply.getDefaultInstance())).setSchemaDescriptor(new GreeterMethodDescriptorSupplier("StreamHello")).build();
                }
            }
        }
    ...
    public interface AsyncService {
        ...
        /**
         */
        default io.grpc.stub.StreamObserver<examples.HelloRequest> streamHello(io.grpc.stub.StreamObserver<examples.HelloReply> responseObserver) {
            return io.grpc.stub.ServerCalls.asyncUnimplementedStreamingCall(getStreamHelloMethod(), responseObserver);
        }
    }
    ...
    public static class GreeterStub extends io.grpc.stub.AbstractAsyncStub<GreeterStub> {
        ...
        /**
         */
        public io.grpc.stub.StreamObserver<examples.HelloRequest> streamHello(io.grpc.stub.StreamObserver<examples.HelloReply> responseObserver) {
            return io.grpc.stub.ClientCalls.asyncBidiStreamingCall(getChannel().newCall(getStreamHelloMethod(), getCallOptions()), responseObserver);
        }
    }
    ...
    public static class GreeterBlockingV2Stub extends io.grpc.stub.AbstractBlockingStub<GreeterBlockingV2Stub> {
        ...
        public io.grpc.stub.BlockingClientCall<examples.HelloRequest, examples.HelloReply> streamHello() {
            return io.grpc.stub.ClientCalls.blockingBidiStreamingCall(getChannel(), getStreamHelloMethod(), getCallOptions());
        }
    }
        ...
        public io.grpc.stub.StreamObserver<Req> invoke(io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch(methodId) {
                case METHODID_STREAM_HELLO:
                    return (io.grpc.stub.StreamObserver<Req>) serviceImpl.streamHello((io.grpc.stub.StreamObserver<examples.HelloReply>) responseObserver);
                default:
                    throw new AssertionError();
            }
        }
    ...
    public static io.grpc.ServerServiceDefinition bindService(AsyncService service) {
        return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor()).addMethod(getSayHelloMethod(), io.grpc.stub.ServerCalls.asyncUnaryCall(new MethodHandlers<examples.HelloRequest, examples.HelloReply>(service, METHODID_SAY_HELLO))).addMethod(getStreamHelloMethod(), io.grpc.stub.ServerCalls.asyncBidiStreamingCall(new MethodHandlers<examples.HelloRequest, examples.HelloReply>(service, METHODID_STREAM_HELLO))).build();
    }
    ...
    public static io.grpc.ServiceDescriptor getServiceDescriptor() {
        ...
        if (result == null) {
            synchronized (GreeterGrpc.class) {
                ...
                if (result == null) {
                    serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME).setSchemaDescriptor(new GreeterFileDescriptorSupplier()).addMethod(getSayHelloMethod()).addMethod(getStreamHelloMethod()).build();
                }
            }
        }
        return result;
