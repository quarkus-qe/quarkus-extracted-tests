...
public final class StreamingGrpc {
     ...
     */
    public static StreamingBlockingV2Stub newBlockingV2Stub(io.grpc.Channel channel) {
        io.grpc.stub.AbstractStub.StubFactory<StreamingBlockingV2Stub> factory = new io.grpc.stub.AbstractStub.StubFactory<StreamingBlockingV2Stub>() {
     ...
     * </pre>
     */
    public static class StreamingBlockingV2Stub extends io.grpc.stub.AbstractBlockingStub<StreamingBlockingV2Stub> {

        private StreamingBlockingV2Stub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            super(channel, callOptions);
        }

        @java.lang.Override
        protected StreamingBlockingV2Stub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new StreamingBlockingV2Stub(channel, callOptions);
        }
        ...
        public io.grpc.stub.BlockingClientCall<?, io.grpc.examples.streaming.Item> source(io.grpc.examples.streaming.Empty request) {
            return io.grpc.stub.ClientCalls.blockingV2ServerStreamingCall(getChannel(), getSourceMethod(), getCallOptions(), request);
        }

        /**
         */
        @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/10918")
        public io.grpc.stub.BlockingClientCall<io.grpc.examples.streaming.Item, io.grpc.examples.streaming.Empty> sink() {
            return io.grpc.stub.ClientCalls.blockingClientStreamingCall(getChannel(), getSinkMethod(), getCallOptions());
        }

        /**
         */
        @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/10918")
        public io.grpc.stub.BlockingClientCall<io.grpc.examples.streaming.Item, io.grpc.examples.streaming.Item> pipe() {
            return io.grpc.stub.ClientCalls.blockingBidiStreamingCall(getChannel(), getPipeMethod(), getCallOptions());
        }

        /**
         */
        @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/10918")
        public io.grpc.stub.BlockingClientCall<io.grpc.examples.streaming.StringRequest, io.grpc.examples.streaming.StringReply> quickStringStream() {
            return io.grpc.stub.ClientCalls.blockingClientStreamingCall(getChannel(), getQuickStringStreamMethod(), getCallOptions());
        }

        /**
         */
        @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/10918")
        public io.grpc.stub.BlockingClientCall<io.grpc.examples.streaming.StringRequest, io.grpc.examples.streaming.StringReply> midStringStream() {
            return io.grpc.stub.ClientCalls.blockingClientStreamingCall(getChannel(), getMidStringStreamMethod(), getCallOptions());
        }

        /**
         */
        @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/10918")
        public io.grpc.stub.BlockingClientCall<io.grpc.examples.streaming.StringRequest, io.grpc.examples.streaming.StringReply> quickStringBiDiStream() {
            return io.grpc.stub.ClientCalls.blockingBidiStreamingCall(getChannel(), getQuickStringBiDiStreamMethod(), getCallOptions());
        }

        /**
         */
        @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/10918")
        public io.grpc.stub.BlockingClientCall<io.grpc.examples.streaming.StringRequest, io.grpc.examples.streaming.StringReply> midStringBiDiStream() {
            return io.grpc.stub.ClientCalls.blockingBidiStreamingCall(getChannel(), getMidStringBiDiStreamMethod(), getCallOptions());
        }
    }
