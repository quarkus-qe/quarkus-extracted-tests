...
/**
 * Implements Jakarta Data repository {@link io.quarkus.it.hibernate.jpamodelgen.data.MyRepository}
 **/
@Dependent
...
public class MyRepository_ implements MyRepository {
	 ...
	 * Find {@link MyEntity}.
	 *
	 * @see io.quarkus.it.hibernate.jpamodelgen.data.MyRepository#findAll(Order)
	 **/
	@Override
	public Stream<MyEntity> findAll(Order<MyEntity> order) {
