...
/**
 * Implements Jakarta Data repository {@link io.quarkus.it.hibernate.processor.data.puother.DenyAllMyOtherRepository}
 **/
@Dependent
@Generated("org.hibernate.processor.HibernateProcessor")
public class DenyAllMyOtherRepository_ implements DenyAllMyOtherRepository {
	...
	/**
	 * @see #findByNamePermitAll(String)
	 **/
	static final String FIND_BY_NAME_PERMIT_ALL_String = "select e from MyOtherEntity e where e.name like :name";

	
	protected @Nonnull StatelessSession session;
	
	@Inject
	public DenyAllMyOtherRepository_(@Nonnull @PersistenceUnit("other") StatelessSession session) {
	 ...
	 *
	 * @see io.quarkus.it.hibernate.processor.data.puother.DenyAllMyOtherRepository#findByName(String)
	 **/
	@Override
	...
	/**
	 * Execute the query {@value #FIND_BY_NAME_PERMIT_ALL_String}.
	 *
	 * @see io.quarkus.it.hibernate.processor.data.puother.DenyAllMyOtherRepository#findByNamePermitAll(String)
	 **/
	@Override
	public List<MyOtherEntity> findByNamePermitAll(String name) {
		try {
			var _select = session.createSelectionQuery(FIND_BY_NAME_PERMIT_ALL_String, MyOtherEntity.class)
				.setParameter("name", name);
			return _select
				.getResultList();
		}
	 ...
	 *
	 * @see io.quarkus.it.hibernate.processor.data.puother.DenyAllMyOtherRepository#findById(Integer)
	 **/
	@Override
	 ...
	 *
	 * @see io.quarkus.it.hibernate.processor.data.puother.DenyAllMyOtherRepository#findAll()
	 **/
	@Override
	 ...
	 * Find {@link MyOtherEntity}.
	 *
	 * @see io.quarkus.it.hibernate.processor.data.puother.DenyAllMyOtherRepository#findAll(PageRequest,Order)
	 **/
	@Override
	 ...
	 *
	 * @see io.quarkus.it.hibernate.processor.data.puother.DenyAllMyOtherRepository#deleteById(Integer)
	 **/
	@Override
