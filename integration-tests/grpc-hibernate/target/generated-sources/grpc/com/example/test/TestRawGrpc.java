...
public final class TestRawGrpc {
     ...
     */
    public static TestRawBlockingV2Stub newBlockingV2Stub(io.grpc.Channel channel) {
        io.grpc.stub.AbstractStub.StubFactory<TestRawBlockingV2Stub> factory = new io.grpc.stub.AbstractStub.StubFactory<TestRawBlockingV2Stub>() {

            @java.lang.Override
            public TestRawBlockingV2Stub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
                return new TestRawBlockingV2Stub(channel, callOptions);
            }
        };
        return TestRawBlockingV2Stub.newStub(factory, channel);
    }
     ...
     */
    public static class TestRawBlockingV2Stub extends io.grpc.stub.AbstractBlockingStub<TestRawBlockingV2Stub> {

        private TestRawBlockingV2Stub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            super(channel, callOptions);
        }

        @java.lang.Override
        protected TestRawBlockingV2Stub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new TestRawBlockingV2Stub(channel, callOptions);
        }

        /**
         */
        public com.example.test.TestOuterClass.Empty add(com.example.test.TestOuterClass.Item request) throws io.grpc.StatusException {
            return io.grpc.stub.ClientCalls.blockingV2UnaryCall(getChannel(), getAddMethod(), getCallOptions(), request);
        }

        /**
         */
        @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/10918")
        public io.grpc.stub.BlockingClientCall<?, com.example.test.TestOuterClass.Item> getAll(com.example.test.TestOuterClass.Empty request) {
            return io.grpc.stub.ClientCalls.blockingV2ServerStreamingCall(getChannel(), getGetAllMethod(), getCallOptions(), request);
        }

        /**
         */
        public com.example.test.TestOuterClass.Empty clear(com.example.test.TestOuterClass.Empty request) throws io.grpc.StatusException {
            return io.grpc.stub.ClientCalls.blockingV2UnaryCall(getChannel(), getClearMethod(), getCallOptions(), request);
        }

        /**
         */
        @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/10918")
        public io.grpc.stub.BlockingClientCall<com.example.test.TestOuterClass.Item, com.example.test.TestOuterClass.Item> bidi() {
            return io.grpc.stub.ClientCalls.blockingBidiStreamingCall(getChannel(), getBidiMethod(), getCallOptions());
        }
    }

    /**
     * A stub to allow clients to do limited synchronous rpc calls to service TestRaw.
     */
