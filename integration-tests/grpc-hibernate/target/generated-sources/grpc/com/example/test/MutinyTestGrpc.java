...
import static com.example.test.TestGrpc.getServiceDescriptor;
...
public final class MutinyTestGrpc implements io.quarkus.grpc.MutinyGrpc {

    private MutinyTestGrpc() {
    }

    public static MutinyTestStub newMutinyStub(io.grpc.Channel channel) {
        return new MutinyTestStub(channel);
    }

    public static class MutinyTestStub extends io.grpc.stub.AbstractStub<MutinyTestStub> implements io.quarkus.grpc.MutinyStub {

        private TestGrpc.TestStub delegateStub;

        private MutinyTestStub(io.grpc.Channel channel) {
            super(channel);
            delegateStub = TestGrpc.newStub(channel);
        }

        private MutinyTestStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            super(channel, callOptions);
            delegateStub = TestGrpc.newStub(channel).build(channel, callOptions);
        }

        @Override
        protected MutinyTestStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new MutinyTestStub(channel, callOptions);
        }
    ...
    public static abstract class TestImplBase implements io.grpc.BindableService {
         ...
         */
        public TestImplBase withCompression(String compression) {
        ...
        public io.grpc.ServerServiceDefinition bindService() {
            return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor()).addMethod(com.example.test.TestGrpc.getAddMethod(), asyncUnaryCall(new MethodHandlers<com.example.test.TestOuterClass.Item, com.example.test.TestOuterClass.Empty>(this, METHODID_ADD, compression))).addMethod(com.example.test.TestGrpc.getGetAllMethod(), asyncServerStreamingCall(new MethodHandlers<com.example.test.TestOuterClass.Empty, com.example.test.TestOuterClass.Item>(this, METHODID_GET_ALL, compression))).addMethod(com.example.test.TestGrpc.getClearMethod(), asyncUnaryCall(new MethodHandlers<com.example.test.TestOuterClass.Empty, com.example.test.TestOuterClass.Empty>(this, METHODID_CLEAR, compression))).addMethod(com.example.test.TestGrpc.getBidiMethod(), asyncBidiStreamingCall(new MethodHandlers<com.example.test.TestOuterClass.Item, com.example.test.TestOuterClass.Item>(this, METHODID_BIDI, compression))).build();
        }
    }
    ...
    private static final class MethodHandlers<Req, Resp> implements io.grpc.stub.ServerCalls.UnaryMethod<Req, Resp>, io.grpc.stub.ServerCalls.ServerStreamingMethod<Req, Resp>, io.grpc.stub.ServerCalls.ClientStreamingMethod<Req, Resp>, io.grpc.stub.ServerCalls.BidiStreamingMethod<Req, Resp> {
        ...
        MethodHandlers(TestImplBase serviceImpl, int methodId, String compression) {
