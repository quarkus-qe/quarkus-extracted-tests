...
public final class TestGrpc {
     ...
     */
    public static TestBlockingV2Stub newBlockingV2Stub(io.grpc.Channel channel) {
        io.grpc.stub.AbstractStub.StubFactory<TestBlockingV2Stub> factory = new io.grpc.stub.AbstractStub.StubFactory<TestBlockingV2Stub>() {
     ...
     */
    public static class TestBlockingV2Stub extends io.grpc.stub.AbstractBlockingStub<TestBlockingV2Stub> {

        private TestBlockingV2Stub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            super(channel, callOptions);
        }

        @java.lang.Override
        protected TestBlockingV2Stub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new TestBlockingV2Stub(channel, callOptions);
        }
