...
public class TestRawBean extends MutinyTestRawGrpc.TestRawImplBase implements BindableService, MutinyBean {

    private final TestRaw delegate;

    TestRawBean(@GrpcService TestRaw delegate) {
