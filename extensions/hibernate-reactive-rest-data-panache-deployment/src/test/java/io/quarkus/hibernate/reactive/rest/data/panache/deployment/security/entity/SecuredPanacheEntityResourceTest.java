    ...
    static final QuarkusUnitTest TEST = new QuarkusUnitTest()
            .withApplicationRoot((jar) -> jar
                    .addClasses(Collection.class, AbstractEntity.class, AbstractItem.class,
                            ...
                            EmptyListItem.class, EmptyListItemsResource.class, PermissionCheckerBean.class)
            ...
            .setForcedDependencies(List.of(
                    ...
                    Dependency.of("io.quarkus", "quarkus-elytron-security-properties-file-deployment", System.getProperty("core.quarkus.version"))));
