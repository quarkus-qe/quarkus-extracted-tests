...
public class HalLinksWithJacksonTest extends AbstractHalLinksTest {
    ...
    static final QuarkusProdModeTest TEST = new QuarkusProdModeTest()
            ...
            .setForcedDependencies(List.of(
                    Dependency.of("io.quarkus", "quarkus-resteasy-jackson", System.getProperty("core.quarkus.version")),
                    Dependency.of("io.quarkus", "quarkus-hal", System.getProperty("core.quarkus.version"))))
